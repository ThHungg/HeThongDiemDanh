    ...
    <div className="bg-white p-5 mb-[12px] rounded-xl shadow-sm">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center gap-2">
          <input
            type="text"
            placeholder="Dán chuỗi MSV liên tục (A46588A56162...)"
            className="px-3 py-2 bg-[#F8FAFC] w-full text-[13px] rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#8B0000]/80"
          />
          <div className="py-1 bg-[#F8FAFC] text-[13px] rounded-lg w-fit border border-gray-100 min-w-[65px] text-center">
            <p className="text-[11px] font-semibold text-gray-500">Tổng</p>
        ...
        <div className="grid grid-cols-5 mt-3 gap-2 w-full">
          ...
          <div className="flex flex-col gap-1">
            <label
              ...
              className="font-bold text-[13px] text-[#737373]"
            >
              Khóa học
            </label>
            <select
              name=""
              id=""
              className="bg-[#F8FAFC] p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#8B0000]/80"
            >
